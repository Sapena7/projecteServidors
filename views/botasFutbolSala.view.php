    ...
    <div class="products">
        <div class="container">
            <div class="row">
                <div class="col">
                    <form action="<?php
                    echo $route->generateURL('Product', 'getBotasFutbolSalaFiltered') ?>" name="search_form" method="GET">
                        ...
                        foreach ($products as $product) {
                            ...
                            <div class="product">
                                <div class="product_image">
                                    <img src="/projecteServidors/images/botasFutbolSala/<?php echo $product->getImg();?>" alt=""></div>
                        ...
                        <ul>
                            ...
                            if ($previous!=0){ ?>
                                <li class="active"><a href="<?php
                                    echo $route->generateURL('Product', 'getBotasFutbolSalaFiltered') . "?pages=" . $previous . $fechaMin . $fechaMax . $textFilter ?>">Previous</a></li>
                            <?php }
                            ?>
                            ...
                            for ($i = 1; $i<=$pages; $i++){?>
                                <li class="active"><a href="<?php
                                    echo $route->generateURL('Product', 'getBotasFutbolSalaFiltered') . "?pages=" . $i . $fechaMin . $fechaMax . $textFilter?>"><?=$i?></a></li>
                                <?php
                            }
                            ?>
                            <?php
                            if ($next<=$pages){ ?>
                                <li class="active"><a href="<?php
                                    echo $route->generateURL('Product', 'getBotasFutbolSalaFiltered') . "?pages=" . $next . $fechaMin . $fechaMax . $textFilter?>">Next</a></li>
                            <?php }?>
